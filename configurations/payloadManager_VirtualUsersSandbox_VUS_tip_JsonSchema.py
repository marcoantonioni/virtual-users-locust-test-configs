...
#==========================
# Create Json schema for LoanRequestData json type
jschema_LoanRequestData= {
    "name": "LoanRequestData",
    "properties": {
        "activeLoans": {"type": "integer"},
        "amountRequested": {"type": "number"},
        "badPayer": {"type": "boolean"},
        "challengeYourLuck": {"type": "boolean"},
        "loanDurationMonths": {"type": "integer"},
        "requestorAnnualNetIncome": {"type": "number"},
        "userName": {"type": "string"}},
    "additionalProperties": False
}

# ----------------------------------
# Class definition for LoanRequestData
# usage samples: youVar = LoanRequestData(), yourVar = LoanRequestData( {...} )
LoanRequestData = warlock.model_factory(jschema_LoanRequestData)
